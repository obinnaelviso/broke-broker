@section('title', 'Forgot Password - Royal Imperial Bank')
<!DOCTYPE html>
<html lang="zxx">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              ...
              <form action="{{ route('suser.password.email') }}" method="POST" class="row" style="position: relative; margin: 0 auto; width: 450px;">
                  @csrf
                <div class="col-lg-12">
