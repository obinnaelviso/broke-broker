...
<nav class="nav-section">
    <div class="container">
        <ul class="main-menu">
            <!-- logo -->
            <a href="/" class="desktop-logo text-uppercase" style="color: white; font-size: 28px; font-weight: 900;">247<span style="color: orange">FX</span>TRADING</a>
            ...
            @endguest
            @auth
            <li><a href="{{ route('user.home') }}">GO TO DASHBOARD</a></li>
            @endauth
        </ul>
    </div>
</nav>
